...
-   The genotype field can have mutl

-   NHS numbers may not have been entered on DNA Database or iGene, which could lead to results being missed when joining results using an NHS number.

-   DNA database and iGene have different names for the same variable.
    Example: R number DNA database also has different names for the same variable in different tables.
...
Embrace and display the imperfection of joining these data together.
